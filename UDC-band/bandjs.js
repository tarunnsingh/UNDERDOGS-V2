...
if(screen.width>800)
{
  ...
  document.getElementsByClassName("videog")[0].setAttribute("href","#s1");
  document.getElementsByClassName("videog")[1].setAttribute("href","#s1");
  document.getElementsByClassName("videog")[2].setAttribute("href","#s1");
...
autoplay:true,
autoplaySpeed:2000,
prevArrow: '<a class= "carbtn btn carl " ><i class="fas fa-chevron-left" ></i></a>',
nextArrow: '<a class= "carbtn btn carr " ><i class="fas fa-chevron-right" ></i></a>',
slidesToShow: 3,
slidesToScroll: 3,
responsive: [
{
